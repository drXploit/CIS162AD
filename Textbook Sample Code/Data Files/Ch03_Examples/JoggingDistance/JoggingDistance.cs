...
namespace JoggingDistance
{
    class JoggingDistance
    {
        ...
        static double CalculateAvgSteps(int initialStrideCount,
        ...
        static double CalculateDistance(double numberOfStepsPerMin,
                                                int totalMinutes)
        {
        ...
        static void DisplayResults(double numberOfStepsPerMin, int hrs,
                                            int mins, double distanceTraveled)
        {
            Clear();
            WriteLine("{0,35}", "Jogging Distance Calculator");
            WriteLine();
            WriteLine("{0,-25} {1} Feet Per Step", "Stride:", 2.5);
            WriteLine("{0,-25} {1} Steps", "Strides Per Minute: ",
                              numberOfStepsPerMin);
            WriteLine("{0,-25} {1} Hour(s) and {2} Minute(s)",
                              "Jogging Time:", hrs, mins);
            WriteLine("{0,-25} {1:f2} Miles", "Distance Traveled:",
                              distanceTraveled);
        }
    }
}
